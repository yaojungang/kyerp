 ...
 */
public class QYYTD82407Service implements
		IQYYTD82407Service {
	...
	public void setQYYTD82407DAO(
			IQYYTD82407DAO QYYTD82407DAO) {
	...
	@Override
	public List<QYYTD82407> getList(int currentPage,
			int pageSize) {
		return this.QYYTD82407DAO.getList(currentPage,
				pageSize);
	}
