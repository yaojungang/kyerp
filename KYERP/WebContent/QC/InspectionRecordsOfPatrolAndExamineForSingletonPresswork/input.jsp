...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#000000" bgcolor="#000000" style="border-collapse: collapse; font-size: 16px;">
  ...
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem01Date" type="text" id="examItem01Date" value="${ir.examItem01Date}" size="20" /> <img onclick="WdatePicker({el:'examItem01Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem03Date" type="text" id="examItem03Date" value="${ir.examItem03Date}" size="20" /> <img onclick="WdatePicker({el:'examItem03Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem04Date" type="text" id="examItem04Date" value="${ir.examItem04Date}" size="20" /> <img onclick="WdatePicker({el:'examItem04Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem05Date" type="text" id="examItem05Date" value="${ir.examItem05Date}" size="20" /> <img onclick="WdatePicker({el:'examItem05Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem06Date" type="text" id="examItem06Date" value="${ir.examItem06Date}" size="20" /> <img onclick="WdatePicker({el:'examItem06Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem07Date" type="text" id="examItem07Date" value="${ir.examItem07Date}" size="20" /> <img onclick="WdatePicker({el:'examItem07Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem08Date" type="text" id="examItem08" value="${ir.examItem08Date}" size="20" /> <img onclick="WdatePicker({el:'examItem08Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem09Date" type="text" id="examItem09Date" value="${ir.examItem09Date}" size="20" /> <img onclick="WdatePicker({el:'examItem09Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
    ...
    <td height="40" align="center" valign="middle" bgcolor="#FFFFFF"><input name="ir.examItem10Date" type="text" id="examItem10Date" value="${ir.examItem10Date}" size="20" /> <img onclick="WdatePicker({el:'examItem10Date',dateFmt:'yyyy-MM-dd H:mm:ss'})" src="${pageContext.request.contextPath}/Library/js/DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle"></td>
  </tr>
  <tr>
