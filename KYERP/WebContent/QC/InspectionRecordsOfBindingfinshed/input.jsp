...
</table><form action="${pageContext.request.contextPath}/QC/InspectionRecordsOfBindingfinshed/save.action" method="post" id="form">
<table width="750" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#000000" bgcolor="#000000" style="border-collapse: collapse; font-size: 16px;">
  <tr>
    ...
    <td height="40" colspan="5" align="center" valign="middle" bgcolor="#FFFFFF">
    </td>
