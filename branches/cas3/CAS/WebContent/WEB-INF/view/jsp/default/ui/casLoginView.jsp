...
>
 ...
 /></label> <c:if test="${not empty sessionScope.openIdLocalId}">
 ...
 <div id="list-languages"><c:set var="query"
 ...
 <ul>
  <li class="first"><a
   href="login?${query}${not empty query ? '&' : ''}locale=en"
  >English</a></li>
