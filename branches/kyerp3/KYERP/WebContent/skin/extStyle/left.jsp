...
<table width="100%" border="0" cellpadding="3" cellspacing="0"
	...
	<tr bgcolor="#FFFFFF">
		...
		<form method="post" action="getAFByYWY.action" target="_blank"><input
			type="text" name="YWName" value="" style="width: 60px" /> <s:submit
			value="查询" /></form>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
		<td height="25" align="center"><a
			href="getAFByYWY.action?YWName=yar" target="_blank">杨爱荣</a></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td height="25" align="center"><a
	...
	<tr bgcolor="#FFFFFF">
		<td height="25" align="center"><a
			href="getAFByYWY.action?YWName=syp" target="_blank">孙玉萍</a></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td height="25" align="center"><a
