 ...
 */
public class QYYTD82408Service implements IQYYTD82408Service {
	...
	public void setQYYTD82408DAO(IQYYTD82408DAO QYYTD82408DAO) {
		this.QYYTD82408DAO = QYYTD82408DAO;
	}

	@Override
	public QYYTD82408 find(long id) {
		return this.QYYTD82408DAO.find(id);
	}

	@Override
	public List<QYYTD82408> getList(int currentPage, int pageSize) {
		return this.QYYTD82408DAO.getList(currentPage, pageSize);
	}

	@Override
	public void remove(long id) {
		this.QYYTD82408DAO.remove(id);
	}

	@Override
	public void save(QYYTD82408 insBindingBindingfinshed) {
		this.QYYTD82408DAO.save(insBindingBindingfinshed);
	}

	@Override
	public int getCountAll() {
		return this.QYYTD82408DAO.getCountAll();
	}

	@Override
	public List<QYYTD82408> getByDateRange(Date startDate, Date endDate) {
		return this.QYYTD82408DAO.getByDateRange(startDate, endDate);
	}
