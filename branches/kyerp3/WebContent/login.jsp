                ...
                Ext.form.ComboBox,
                {
                    initComponent : function() {
                        var css = '.ux-icon-combo-icon {background-repeat: no-repeat;background-position: 0 50%;width: 18px;height: 14px;}'
                                ...
                                + ".ux-flag-zh_cn {background-image:url(images/ext-extend/icons/cn_zh.png) !important;}"
                                + ".ux-flag-us {background-image:url(images/ext-extend/icons/en_us.png) !important;}";
...
Ext.onReady( function() {
    ...
    var LoginWindow = new Ext.ux.LoginWindow( {
        ...
        basePath : 'images/ext-extend/icons/',
        winBanner : 'login.jpg',
        url : 'j_spring_security_check',
        locationUrl : 'index.jsp'
    });
    LoginWindow.show();
});
</script>
