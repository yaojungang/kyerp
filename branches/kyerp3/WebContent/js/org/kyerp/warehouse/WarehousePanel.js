...
org.kyerp.warehouse.WarehouseFormPanel = Ext.extend(Ext.form.FormPanel, {
			...
			constructor : function(_cfg) {
				...
				var _readOnly = this["readOnly"] == null
						? false
						: this["readOnly"];
				org.kyerp.warehouse.WarehouseFormPanel.superclass.constructor.call(
						this, {
							labelWidth : 80,
							labelAlign : 'right',
...
/** ***************************************************************************** */
org.kyerp.warehouse.WarehouseInfoWindow = Ext.extend(Ext.Window, {
			url : "",
			form : null,
			constructor : function(_cfg) {
				Ext.apply(this, _cfg);
				this.form = new org.kyerp.warehouse.WarehouseFormPanel({
							url : this.url
						});
				org.kyerp.warehouse.WarehouseInfoWindow.superclass.constructor
						.call(this, {
									plain : true,
									width : 300,
									modal : true,
...
/** ***************************************************************************** */
org.kyerp.warehouse.WarehouseInsertWindow = Ext.extend(
		org.kyerp.warehouse.WarehouseInfoWindow, {
			title : "添 加",
...
/** ***************************************************************************** */
org.kyerp.warehouse.WarehouseUpdateWindow = Ext.extend(
		org.kyerp.warehouse.WarehouseInfoWindow, {
			title : "修 改",
...
/** ***************************************************************************** */
org.kyerp.warehouse.WarehousePanel = Ext.extend(Ext.grid.GridPanel, {
	insertWin : new org.kyerp.warehouse.WarehouseInsertWindow(),
	updateWin : new org.kyerp.warehouse.WarehouseUpdateWindow(),
	constructor : function(_cfg) {
		Ext.apply(this, _cfg);
...
Ext.extend(org.kyerp.module,{
    init: function(){
        this.body = new org.kyerp.warehouse.WarehousePanel({border : false,bodyBorder : false});
