...
ExtWindowResize = function(window){
	/*if(!window.rendered){
	var browerWidth = kyerpApp.viewport.getWidth();
	var browerHeight = kyerpApp.viewport.getHeight();
	var browerTop = window.screenTop; 
	var browerLeft = window.screenLeft;
	window.setWidth(browerWidth - 100);
	window.setHeight(browerHeight - 100);
