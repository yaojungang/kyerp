		...
		if (afes != null) {
			...
			for (Iterator iterator = afes.iterator(); iterator.hasNext();) {
				...
				if (afe.getEType().equals("BB")) { // 计算正文的费用
					...
					BB_Print_fee = EPS * KPA * BB_pk * pks
							* ColorAmount;
				...
				if (afe.getEType().equals("CI")) { // 计算插页费用
					...
					double CI_PS_fee=0;
					if("05".equals(afe.getEMachine())||"双面".equals(afe.getEMachine())) CI_PS_fee = 48;
					if("四色".equals(afe.getEMachine())) CI_PS_fee = 52; 
					...
					if("05".equals(afe.getEMachine())||"双面".equals(afe.getEMachine())) CI_shangPS_fee = 12;
					if("四色".equals(afe.getEMachine())) CI_shangPS_fee = 8; 
