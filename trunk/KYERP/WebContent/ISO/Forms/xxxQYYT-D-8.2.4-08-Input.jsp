...
合格</p>
  <p>
    <label>版面：
      <input type="radio" name="radio" id="收集6" value="收集" />
    </label>
合格
<label>
  <input type="radio" name="radio" id="检查合格6" value="检查合格" />
  不</label>
合格</p>
  <p>
    <label>接版：
      <input type="radio" name="radio" id="收集7" value="收集" />
    </label>
合格
<label>
  <input type="radio" name="radio" id="检查合格7" value="检查合格" />
  不</label>
合格</p>
  <p>
    <label>图文：
      <input type="radio" name="radio" id="收集8" value="收集" />
    </label>
合格
<label>
  <input type="radio" name="radio" id="检查合格8" value="检查合格" />
  不</label>
合格</p>
  <p>
    <label>结论：
