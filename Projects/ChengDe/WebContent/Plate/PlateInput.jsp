...
<body>
<form action="editPlate_save.action" method="post">
<s:if test="#plate.id>0">
	<s:hidden name="plate.id" value="%{#plate.id}" />
</s:if>
<div id="tabs1">
<div class="menu1box">
<ul id="menu1">
	<li class="hover" onClick="setTab(1,0)"><a href="#">修改印版</a></li>
</ul>
</div>
<div class="main1box">
	...
	<table width="90%" border="0" align="center" cellpadding="8"
		...
		<tr>
			...
			<td align="left" bgcolor="#FFFFFF"><input type="text"
				style="width: 100px;" name="plate.danAnNo" value="<s:property value='#plate.danAnNo' />"/></td>
		</tr>
		<tr>
			<td width="80" align="right">印版名称</td>
			<td align="left"><input type="text"
				name="plate.pname" style="width: 200px;" value="<s:property value='#plate.pname' />"/>
			</td>
		</tr>
		<tr>
			<td width="80" align="right">入库时间</td>
			<td align="left"><input type="text" id="plate_inputDate"
				name="plate.inputDate" style="width: 150px;" value="<s:date name='#plate.inputDate' format='yyyy-MM-dd' nice='false' />" /> <div id="plate_inputDateTip"></div></td>
		</tr>
        <tr>
			<td width="80" align="right">最后使用时间</td>
			<td align="left"><input type="text" id="plate_lastUseDate"
				name="plate.lastUseDate" style="width: 150px;" value="<s:date name='#plate.lastUseDate' format='yyyy-MM-dd' nice='false' />" /><div id="plate_lastUseDateTip"></div></td>
		</tr>
        <tr>
			<td width="80" align="right">过期时间</td>
			<td align="left"><input type="text" id="plate_expDate"
				name="plate.expDate" style="width: 150px;" value="<s:date name='#plate.expDate' format='yyyy-MM-dd' nice='false' />" /><div id="plate_expDateTip"></div></td>
		</tr>
		<tr>
			<td width="80" align="right">版号</td>
			<td align="left"><input type="text"
				name="plate.plateNo" style="width: 100px;" value="<s:property value='#plate.plateNo' />"/></td>
		</tr>

		<tr>
			<td width="80" align="right">版长</td>
			<td align="left"><input type="text" id="plate_plateLength"
				name="plate.plateLength" value="<s:property value='#plate.plateLength' />"/></td>
		</tr>
		<tr>
			<td width="80" bgcolor="#FFFFFF" align="right">版周</td>
			<td bgcolor="#FFFFFF" align="left"><input type="text" name="plate.plateWidth" value="<s:property value='#plate.plateWidth' />"/>
			</td>
		</tr>
        <tr>
			<td width="80" bgcolor="#FFFFFF" align="right">支数</td>
			<td bgcolor="#FFFFFF" align="left"><input type="text" name="plate.plateAmount" value="<s:property value='#plate.plateAmount' />"/>
			</td>
		</tr>
        <tr>
			<td width="80" bgcolor="#FFFFFF" align="right">共用版</td>
			<td bgcolor="#FFFFFF" align="left"><input type="text" name="plate.plateShare" value="<s:property value='#plate.plateShare' />"/>
			</td>
		</tr>
        <tr>
			<td width="80" bgcolor="#FFFFFF" align="right">位置编号</td>
			<td bgcolor="#FFFFFF" align="left"><input type="text" name="plate.plateAddress" value="<s:property value='#plate.plateAddress' />"/>
			</td>
		</tr>
