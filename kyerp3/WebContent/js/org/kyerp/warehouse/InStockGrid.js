...
org.kyerp.warehouse.InStockFormPanel = Ext.extend(Ext.form.FormPanel, {
	...
	constructor : function(_cfg) {
		if (_cfg == null)
			_cfg = {};
		Ext.apply(this, _cfg);
		this.detailsGrid = new org.kyerp.warehouse.InStockDetailEditorGrid();
...
/** ***************************************************************************** */
org.kyerp.warehouse.InStockGrid = Ext.extend(Ext.grid.EditorGridPanel, {
	insertWin : null,
	updateWin : null,
	expander : null,
	constructor : function(_cfg) {
		...
		this["store"] = org.kyerp.warehouse.InStockStore;
		org.kyerp.warehouse.InStockGrid.superclass.constructor.call(this, {
					stripeRows : true,
					...
					tbar : [{
								...
								onSelect : function(node) {
									var store = org.kyerp.warehouse.InStockStore;
	...
	onRowSelect : function(_sel, _index, _r) {
		var data = _sel.data;
		var store = org.kyerp.warehouse.InStockDetailStore;
		store.setBaseParam("inStockId", data.id);
		store.load( {
			params : {
				start : 0,
				limit : 20
