...
if (!Ext.ux.Util) {
  ...
  Ext.extend(Ext.ux.Util, Ext.util.Observable,{
     ...
     * 
     *require('Ext.ux.guid.plugin.Designer.css;Ext.ux.guid.plugin.Designer-all',{basedir:'compressed',cssdir:'css',nocache: nocache});
     *  
     *require('SelectSupplierWindow.js',{basedir : 'js/org/kyerp/warehouse'});
     *
     *require('js/org/kyerp/warehouse/SelectSupplierWindow.js');
     *
     *require('SelectSupplierWindow.js;'+'SelectMaterialWindow.js;'+'PurchaseOrderItems.js',{basedir : 'js/org/kyerp/warehouse'});
     */
