/** ***************************************************************************** */
org.kyerp.crm.ClientStore = new Ext.data.Store({
			autoLoad : {
				baseParams : {
					limit : 20
				}
			},
			url : org.kyerp.crm.ClientPanel_STORE_URL,
...
/** ***************************************************************************** */
org.kyerp.crm.ClientFormPanel = Ext.extend(Ext.form.FormPanel, {
	url : "",
	constructor : function(_cfg) {
		...
		org.kyerp.crm.ClientFormPanel.superclass.constructor.call(this,
				{
					labelWidth : 80,
					labelAlign : 'right',
						...
						items : [{
							...
							items : [{
										...
										items : [{
											...
											forceSelection : true,
											rootVisible : false,
											treeUrl : org.kyerp.crm.ClientTypePanel_TREE_URL
										}, {
											fieldLabel : "简拼",
											allowBlank : false,
											name : "nameSpell"
...
/** ***************************************************************************** */
org.kyerp.crm.ClientInfoWindow = Ext.extend(Ext.Window, {
			url : "",
			form : null,
			constructor : function(_cfg) {
				Ext.apply(this, _cfg);
				this.form = new org.kyerp.crm.ClientFormPanel({
							url : this.url
						});
				org.kyerp.crm.ClientInfoWindow.superclass.constructor
						.call(this, {
							plain : true,
									width : 655,
									height : 380,
...
/** ***************************************************************************** */
org.kyerp.crm.ClientInsertWindow = Ext.extend(
		org.kyerp.crm.ClientInfoWindow, {
			title : "添 加",
			iconCls : 'icon-utils-s-add',
			url : org.kyerp.crm.ClientPanel_SAVE_URL,
			onSubmit : function(_form, _action, _values) {
...
/** ***************************************************************************** */
org.kyerp.crm.ClientUpdateWindow = Ext.extend(
		org.kyerp.crm.ClientInfoWindow, {
			title : "修 改",
...
/** ***************************************************************************** */
org.kyerp.crm.ClientPanel = Ext.extend(Ext.grid.GridPanel, {
	insertWin : new org.kyerp.crm.ClientInsertWindow(),
	updateWin : new org.kyerp.crm.ClientUpdateWindow(),
	constructor : function(_cfg) {
		Ext.apply(this, _cfg);
		this["store"] = org.kyerp.crm.ClientStore;
		org.kyerp.crm.ClientPanel.superclass.constructor.call(this, {
			stripeRows : true,
			tbar : [{
						text : "添  加",
						iconCls : 'icon-utils-s-add',
						...
						_onSelect : function(node) {
							var store = org.kyerp.crm.ClientStore;
	...
	removeItem : function() {
		try {
			var _sr = this.getSelected();
			Ext.Ajax.request({
						url : org.kyerp.crm.ClientPanel_DELETE_URL,
						params : {
							ids : _sr.get("id")
						}
					});
...
Ext.extend(org.kyerp.module, {
			init : function() {
				this.body = new org.kyerp.crm.ClientPanel({
							border : false,
							bodyBorder : false
						});
