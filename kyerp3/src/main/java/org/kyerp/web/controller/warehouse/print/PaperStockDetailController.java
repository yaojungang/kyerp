...
@RequestMapping("/warehouse/print/PaperStockDetail/")
public class PaperStockDetailController{
	@Autowired
	...
	public String list(Integer start, Integer limit, Long mCategoryId,String query, Long stockId, Model model) {
		...
		List<PaperStockDetailExtGridRow> rows = new ArrayList<PaperStockDetailExtGridRow>();
		for (StockDetail o : queryResult.getResultlist()) {
			PaperStockDetailExtGridRow n = new PaperStockDetailExtGridRow();
			n.setId(o.getId());
			/** 建立时间 */
	...
	public String save(PaperStockDetailExtGridRow row, ModelMap model) {
